...
@push('plugin-scripts')
  <link rel="stylesheet" href="{{ asset('/assets/plugins/chartjs/chart.min.js') }}">
  <link rel="stylesheet" href="{{ asset('/assets/plugins/jquery-sparkline/jquery.sparkline.min.js') }}">
@endpush
